...
class MSDialect(default.DefaultDialect):
    ...
    def _internal_has_table(self, connection, tablename, owner, **kw):
        if tablename.startswith("#"):  # temporary table
            # mssql does not support temporary main
            # SQL Error [4103] [S0001]: "#v": Temporary main are not allowed
            return bool(
                connection.scalar(
    ...
    def get_view_definition(
        ...
        view_def = connection.execute(
            sql.text(
                ...
                "join sys.main as main on mod.object_id = main.object_id "
                "join sys.schemas as sch on main.schema_id = sch.schema_id "
                "where main.name=:viewname and sch.name=:schname"
            ).bindparams(
