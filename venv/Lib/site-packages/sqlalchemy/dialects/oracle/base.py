...
class OracleDialect(default.DefaultDialect):
    ...
    def _has_table_query(self):
        # materialized main are returned by all_tables
        tables = (
            select(
    ...
    def _all_objects_query(
        ...
        # NOTE: materialized main are listed in all_objects twice;
    ...
    def get_multi_table_options(
        ...
        **kw,
        ...
        if ObjectKind.VIEW in kind and ObjectScope.DEFAULT in scope:
            # add the main (no temporary main)
    ...
    def _column_query(self, owner):
        ...
        # NOTE: on oracle cannot create tables/main without columns and
        # a table cannot have all column hidden:
        # ORA-54039: table must have at least one column that is not invisible
        # all_tab_cols returns data for tables/main/mat-main.
    ...
    def _comment_query(self, owner, scope, kind, has_filter_names):
        ...
        if ObjectKind.TABLE in kind or ObjectKind.VIEW in kind:
            # all_tab_comments returns also plain main
            tbl_view = select(
    ...
    def get_multi_table_comment(
        ...
        **kw,
        ...
        # materialized main by default seem to have a comment like
