...
class ObjectKind(Flag):
    ...
    to reflect tables and plain main ``ObjectKind.TABLE | ObjectKind.VIEW``
    may be used.
    ...
    .. note::
      ...
      check constraints of view return a dict with all the main with
...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    def get_table_names(
        ...
        The names are expected to be real tables only, not main.
    ...
    def has_table(
        ...
        .. versionchanged:: 2.0:: :meth:`.Inspector.has_table` now formally
           ...
           * any type of main (plain or materialized)
    ...
    def get_view_names(
        ...
        .. versionchanged:: 2.0  For those dialects that previously included
           the names of materialized main in this list (currently PostgreSQL),
           this method no longer returns the names of materialized main.
    ...
    def reflect_table(
        ...
        # NOTE: support tables/main with no columns
